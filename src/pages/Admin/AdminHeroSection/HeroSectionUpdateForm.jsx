...
function HeroSectionUpdateForm() {
  const { id } = useParams()
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className='flex items-start gap-3'>
            ...
            <div>
              ...
              <input type="file" accept="image/*" onChange={(e) => uploadImage(e.target.files[0])} name="" id="" className='border px-4 text-gray-500 py-1.5 text-[17px] mt-1 rounded-lg bg-gray-200 dark:bg-[#0b0f19] dark:border-[#011743] border-gray-300 w-full' />
            </div>
          </div>
        ...
        <div className="flex justify-end gap-4 pt-4">
          <button
            ...
            className="px-5 py-2 cursor-pointer rounded-lg border border-gray-300 dark:border-[#011743] text-gray-700 dark:text-white/70 hover:bg-gray-200 dark:hover:bg-white/5 font-semibold"
          >
            Cancel
          </button>
...
export default HeroSectionUpdateForm