  ...
  return (
    <div className="z-100 flex flex-col gap-2 rounded-xl p-5 dark:bg-[#1D1D1D] bg-white border border-gray-300 dark:border-white/10 w-fit h-fit">
      ...
      <div className="text-lg flex flex-col gap-2 p-3 py-1">
        <p
          onClick={() => nav("/")}
          className="px-1 rounded dark:hover:bg-[#111315] hover:bg-gray-100  cursor-pointer"
        >
          PC Games
        </p>
        <p
        ...
        <div
          onClick={logOut}
          className="text-center text-xl p-1 py-2 pb-2.5 mt-1 bg-[#ff04043c]/60 hover:bg-[#ff04043c] font-bold cursor-pointer text-red-600 rounded-xl pb-1.5"
        >
          <span>LogOut</span>
        </div>
      </div>
