...
function ProductsDetails() {
    ...
    return (
        <div className=' p-5 px-7 m-3 bg-[#FFFFFF] dark:bg-[#030318] rounded-lg w-[98%] flex flex-col gap-5'>
            <p className='text-xl text-gray-500 dark:text-white/60 flex gap-2'><span onClick={() => nav("/adminProducts")} className='cursor-pointer'>Products</span> &#62; <span className='dark:text-white text-black font-semibold'>{show}</span></p>
